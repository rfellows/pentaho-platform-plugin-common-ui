 ...
 * A global collection is maintained for each AnalyzerModule that is initialized,
...
define([
    ...
    var AnalyzerModule = declare("analyzer.AnalyzerModule", null, {
        /**
         ...
         *
         * Other options include require parameters, as well as parameters which are
         ...
         * container.
         *
         * reportPath is the repository path to the existing Analyzer report to be opened.
         * If reportPath is not present, catalog and cube must have values to create
         * a new Analyzer report. If all three option parameters are present, reportPath takes
